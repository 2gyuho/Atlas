"""
MySQL 사용자 테이블에 위치 정보와 알림 설정 컬럼 추가
"""
import asyncio
import sys
import os
    ...
    try:
        async with engine.begin() as conn:
            ...
            check_columns = await conn.execute(text("""
                ...
                AND COLUMN_NAME IN ('current_latitude', 'current_longitude', 'alert_enabled', 'alert_radius_km')
            """))
            ...
            columns_to_add = [
                ...
                ("alert_radius_km", "INT DEFAULT 50")
            ]
